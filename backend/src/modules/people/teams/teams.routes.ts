...
import { requireTeamManager } from "./teams.middleware";
...
/**
 * Adds one or more members without replacing existing membership. Open to HR/Admin and the
 * team's own leader.
 */
teamsRouter.post("/:teamId/members", requireTeamManager(), teamsController.addTeamMembers);
...
/**
 * Removes one member while preventing leader removal. Open to HR/Admin and the team's own leader.
 */
teamsRouter.delete(
