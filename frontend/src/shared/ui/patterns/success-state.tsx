...
export function SuccessState({ title, body, className }: SuccessStateProps) {
  return (
    <div
      className={cn(
        "flex gap-3 rounded-[10px] border border-[color:var(--color-success-200)] bg-[color:var(--color-success-50)] p-4",
        className,
      )}
      role="status"
    >
      <CheckCircle2 className="mt-0.5 shrink-0 text-[color:var(--color-success-600)]" size={20} aria-hidden="true" />
