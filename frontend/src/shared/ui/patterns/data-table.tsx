              ...
              >
                {col.sortable && col.sortKey ? (
                  <button
                    type="button"
                    className={cn(
                      "inline-flex items-center gap-1 rounded-sm text-[12px] font-bold uppercase tracking-[0.8px] text-[color:var(--text-tertiary)] outline-none transition-colors hover:text-[color:var(--text-primary)] focus-visible:ring-2 focus-visible:ring-ring",
