    ...
    return (
      <input
        ...
        className={cn(
          ...
          "flex h-10 w-full rounded-md border border-input bg-white px-3.5 py-2.5 text-sm font-medium text-[color:var(--text-primary)] shadow-xs transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-[#a4a7ae] focus-visible:outline-none focus-visible:border-transparent focus-visible:shadow-[0_0_0_3px_rgba(24,29,39,0.06)] focus-visible:[background:linear-gradient(#fff,#fff)_padding-box,linear-gradient(45deg,#fccec0,#ebacc9_33%,#ceb6da_66%,#9fcaed)_border-box] disabled:cursor-not-allowed disabled:opacity-[.38]",
