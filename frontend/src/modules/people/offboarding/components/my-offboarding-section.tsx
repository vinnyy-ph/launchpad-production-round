...
import { useMyOffboarding } from "../hooks/use-offboarding";
import type { SignatoryStatus, SignatureRequest } from "../types/offboarding.types";
 ...
 * read-only clearance checklist. Self-contained — owns its data fetch and every state.
 */
export function MyOffboardingSection() {
